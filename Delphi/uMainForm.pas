...
uses
  uRenderer, uCamera, uScene, uHitable, uMaterial, uColor;
...
begin
  ...
  try
    ...
    Renderer.Scene.Add(TSphere.Create(Vec3F(-1, 0, -1), 0.5, TDielectric.Create(1.5)));
    Renderer.Scene.Add(TSphere.Create(Vec3F(-1, 0, -1), -0.45, TDielectric.Create(1.5)));
